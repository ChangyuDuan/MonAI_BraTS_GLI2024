...
```bash
#1. 基础NAS训练（推荐新手使用） - 完整参数
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_epochs 100 --epochs 400 --batch_size 2 --learning_rate 1e-4 --device cuda --output_dir ./outputs
...
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type progressive --nas_epochs 100 --epochs 400 --max_layers 10 --start_layers 4 --batch_size 2 --learning_rate 1e-4 --device cuda --output_dir ./outputs

#4. 超网络训练（一次训练多种架构） - 完整参数
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type supernet --nas_epochs 100 --epochs 400 --base_channels 64 --num_layers 6 --batch_size 2 --learning_rate 1e-4 --device cuda --output_dir ./outputs
...
- `--nas_type`：NAS搜索策略类型（**可选参数**）
  ...
  - `supernet`：超网络训练，一次训练包含多种子架构的大网络

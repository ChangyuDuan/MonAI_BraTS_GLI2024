...
基础模型是单个深度学习架构的训练，适合快速验证和基准测试。训练完成后模型将保存在 `./outputs/checkpoints/best_model.pth`。

```bash
# 使用默认配置训练UNet模型
python main.py --mode train --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练特定模型
python main.py --mode train --model_names SegResNet --epochs 100 --batch_size 4 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练UNETR模型（Transformer架构）
python main.py --mode train --model_names UNETR --epochs 150 --learning_rate 1e-4 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练SwinUNETR模型（Swin Transformer）
python main.py --mode train --model_names SwinUNETR --epochs 200 --batch_size 2 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练AttentionUNet模型（注意力机制）
python main.py --mode train --model_names AttentionUNet --epochs 120 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练VNet模型（3D卷积）
python main.py --mode train --model_names VNet --epochs 100 --batch_size 3 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 训练HighResNet模型（高分辨率）
python main.py --mode train --model_names HighResNet --epochs 150 --data_dir /path/to/BraTS_data --output_dir ./outputs

# 自定义输出目录训练
python main.py --mode train --model_names UNet --data_dir /path/to/BraTS_data --output_dir ./my_models
# 模型将保存在：./my_models/checkpoints/best_model.pth
```
...
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --epochs 200 --batch_size 2 --output_dir ./outputs

# 自定义融合模型组合
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet UNETR --epochs 250 --learning_rate 5e-5 --output_dir ./outputs

# 完整融合网络（所有7个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet UNETR SwinUNETR AttentionUNet VNet HighResNet --epochs 300 --batch_size 1 --output_dir ./outputs

# 融合网络高级配置
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet AttentionUNet --fusion_type cross_attention --fusion_channels 64 128 256 512 --epochs 200 --output_dir ./outputs

# 自定义输出目录的融合网络训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --output_dir ./my_advanced_models
# 模型将保存在：./my_advanced_models/models/fusion_model/checkpoints/best_model.pth
```
...
```bash
# 基础NAS训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_epochs 50 --epochs 300 --batch_size 1 --output_dir ./outputs

# DARTS架构搜索
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type searcher --nas_epochs 80 --arch_lr 3e-4 --model_lr 1e-3 --epochs 400 --output_dir ./outputs

# 渐进式NAS
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type progressive --max_layers 6 --start_layers 2 --nas_epochs 60 --epochs 350 --output_dir ./outputs

# 超网络训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type supernet --base_channels 32 --num_layers 4 --epochs 250 --output_dir ./outputs

# 自定义输出目录的NAS训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --output_dir ./my_nas_models
# 模型将保存在：./my_nas_models/models/nas_model/checkpoints/best_model.pth
```

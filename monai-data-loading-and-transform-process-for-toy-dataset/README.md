...
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --epochs 200 --batch_size 2

# 自定义融合模型组合
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet UNETR --epochs 250 --learning_rate 5e-5

# 完整融合网络（所有7个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet UNETR SwinUNETR AttentionUNet VNet HighResNet --epochs 300 --batch_size 1

# 融合网络高级配置
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type fusion --fusion_models UNet SegResNet AttentionUNet --fusion_type cross_attention --fusion_channels 64 128 256 512 --epochs 200
```
...
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type distillation --student_model UNet --epochs 150

# 自定义教师模型的知识蒸馏
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type distillation --teacher_models UNETR SwinUNETR SegResNet --student_model UNet --distillation_temperature 4.0 --distillation_alpha 0.7 --epochs 200

# 多教师蒸馏高级配置
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type distillation --teacher_models UNet SegResNet UNETR SwinUNETR AttentionUNet --student_model UNet --distillation_type multi_teacher --distillation_temperature 5.0 --distillation_alpha 0.8 --epochs 250

# 渐进式知识蒸馏
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type distillation --teacher_models UNETR SwinUNETR --student_model UNet --distillation_type progressive --progressive_stages 3 --epochs 180
```
...
```bash
# 基础NAS训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_epochs 50 --epochs 300 --batch_size 1

# DARTS架构搜索
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type searcher --nas_epochs 80 --arch_lr 3e-4 --model_lr 1e-3 --epochs 400

# 渐进式NAS
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type progressive --max_layers 6 --start_layers 2 --nas_epochs 60 --epochs 350

# 超网络训练
python main.py --mode train --data_dir /path/to/BraTS_data --model_category advanced --model_type nas --nas_type supernet --base_channels 32 --num_layers 4 --epochs 250
```
...
```bash
# 基础并行集成（2个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet --parallel true --epochs 100

# 中等规模并行集成（3个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet UNETR --parallel true --epochs 150

# 大规模并行集成（5个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet UNETR SwinUNETR AttentionUNet --parallel true --epochs 200

# 完整并行集成（所有7个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --enable_ensemble --parallel true --epochs 250 --batch_size 2

# 自定义并行集成配置
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet UNETR AttentionUNet --parallel true --ensemble_weights 0.3 0.3 0.2 0.2 --epochs 180
```
...
```bash
# 基础逐个集成（2个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet --parallel false --epochs 120

# 中等规模逐个集成（3个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet UNETR --parallel false --epochs 180

# 完整逐个集成（所有7个模型）
python main.py --mode train --data_dir /path/to/BraTS_data --enable_ensemble --parallel false --epochs 300 --batch_size 4

# 逐个集成高级配置
python main.py --mode train --data_dir /path/to/BraTS_data --model_names UNet SegResNet UNETR SwinUNETR --parallel false --learning_rate 1e-4 --weight_decay 1e-5 --epochs 200
```
